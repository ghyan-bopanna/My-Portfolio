...
scene.fog = new THREE.Fog('#0a1832', params.fogNear, params.fogFar)
...
// ─── Background scroll (disabled — video handles bg) ────────────────────────
// updateBg is no-op; kept for GUI color controls to avoid errors
function updateBg() {}
...
function setDebug(v) {
  ...
  document.querySelectorAll('#home, #about, #experience, #projects, #contact').forEach((el) => {
